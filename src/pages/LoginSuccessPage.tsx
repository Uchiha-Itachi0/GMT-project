...
const LoginSuccessPage: React.FC = () => {
    ...
    return (
    <div className="relative flex flex-col justify-end items-center sm:p-12 p-6 min-h-screen w-screen sm:w-[50vw] md:w-[40vw] lg:w-[30vw] bg-cover bg-center shadow-xl"
